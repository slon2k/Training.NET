...
namespace Tasks.Tests.FrameworkTests
{
    ...
    public class Task101Tests
    {
        ...
        [TestCase("Bill Gates", "+1 (555) 123 55 55", 1000000, new string[] { "name", "phone", "revenue" }, ExpectedResult = "Bill Gates, +1 (555) 123 55 55, $1,000,000.00")]
        [TestCase("Bill Gates", "+1 (555) 123 55 55", 1000000, new string[] { "name", "revenue", "phone" }, ExpectedResult = "Bill Gates, $1,000,000.00, +1 (555) 123 55 55")]
